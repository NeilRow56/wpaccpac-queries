...
import {
  getWagesAndSalariesScheduleAction,
  saveWagesAndSalariesScheduleAction
} from '@/server-actions/simple-schedules/wages-and-salaries'
...
export default async function WagesAndSalariesPage({
  params
}: {
  ...
  const crumbs = buildPeriodLeafBreadcrumbs({
    ...
    leafLabel: 'Wages and salaries',
    leafHref: `/organisation/clients/${clientId}/accounting-periods/${periodId}/wages-and-salaries`
  })
        ...
        <div className='flex items-start gap-3'>
          ...
          <div>
            ...
            <p className='text-muted-foreground text-sm'>
              You must have the selected accounting period open to edit wages
              and salaries.
            </p>
          </div>
        </div>
  ...
  const res = await getWagesAndSalariesScheduleAction({ clientId, periodId })
  ...
  return (
    <div className='container mx-auto space-y-6 py-10'>
      ...
      <SimpleScheduleForm
        ...
        onSave={saveWagesAndSalariesScheduleAction}
        derivedLineIds={[]}
        derivedHelpByLineId={{}}
